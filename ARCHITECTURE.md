...
> Подробный справочник по компонентам системы. README содержит обзор и quick start;
> здесь — детали для разработчиков и операторов. Если изменяете код, синхронизируйте
> этот файл.
...
- [Структура проекта](#структура-проекта-полная)
- [ETL-пайплайн](#etl-пайплайн)
- [Классификация статей](#классификация-статей)
- [ML-сервис](#ml-сервис)
- [Training Pipeline (GUI)](#training-pipeline-gui)
- [Обучение модели (CLI)](#обучение-модели-cli)
- [Shiny GUI — вкладки](#shiny-gui--вкладки)
